...
public class EditarDatos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("EDICIÓN DE DATOS");
        ...
        btngua.setText("Guardar cambios");
    ...
    private void btnguaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnguaActionPerformed
        ...
        ctr.ediMas(mas,m_nom,m_raz,m_col,m_ale,m_aes,m_obs,d_nom,d_cel);
        
        mostrarmsj("Modificación realizada","info","Modificación");
    ...
    private void carDat(int m_num) {
        this.mas = ctr.traeMas(m_num);
        txtnom.setText(mas.getM_nom());
        txtraz.setText(mas.getM_raz());
        txtcol.setText(mas.getM_col());
        txtndue.setText(mas.getDue().getD_cel());
        txtobs.setText(mas.getM_obs());
        txtdue.setText(mas.getDue().getD_nom());
        if(mas.getM_ale().equalsIgnoreCase("si")){
            cmbale.setSelectedIndex(1);
        } else {
            if (mas.getM_ale().equalsIgnoreCase("no")){
            cmbale.setSelectedIndex(2);
            }
        }
        
        if(mas.getM_aes().equalsIgnoreCase("si")){
            cmbatesp.setSelectedIndex(1);
        } else {
            if (mas.getM_aes().equalsIgnoreCase("no")){
